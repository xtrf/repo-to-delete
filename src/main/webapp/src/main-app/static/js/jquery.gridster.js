...
;(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        serialize_params: function($w, wgd) {
    		if(typeof wgd === undefined || wgd === undefined || typeof wgd.col === undefined ){
    ...
    fn.register_widget = function($el) {
        ...
        if (this.options.avoid_overlapped_widgets &&
            ...
            $el.attr({
                ...
                'data-widget': wgd.widget,
                'data-params': wgd.params
            });
        }
    ...
    */
    fn.on_start_drag = function(event, ui) {
    	if(ui.helper.hasClass('add-widget'))
    		return;
    ...
    */
    fn.set_placeholder = function(col, row) {
        ...
        this.$preview_holder.css('width',phgd.size_x*this.options.widget_base_dimensions[0]+(phgd.size_x-1)*this.options.widget_margins[0]);
        
        
        /*this.$preview_holder.css: {
            width: coords.width,
            height: coords.height
        };*/
