...
var loadedLanguage;
var oldLanguage = null;
(function() {
  var $, normaliseLang;
  var fallbackLanguageData;
  ...
  $.defaultLanguage = normaliseLang(navigator.language || navigator.userLanguage);
	...
	$.loadFallbackLanguage = function(fallbackLanguage){
		var successFunction = function(data) {
			fallbackLanguageData = data;
		}

		if (!fallbackLanguageData) {
			$.ajax({
				url: 'i18n/customers-'+fallbackLanguage+'.json',
				dataType: "json",
				async: false,
  ...
  $.localize = function(pkg, options) {
    ...
    loadLanguage = function(pkg, lang, level) {
      ...
      switch (level) {
        ...
        case 2:
          if (lang.length >= 2) {
            file = "" + pkg + "-" + (lang.substring(0)) + "." + fileExtension;
            return jsonCall(file, pkg, lang, level);
          }
          break;
        case 3:
    ...
    jsonCall = function(file, pkg, lang, level) {
      ...
      if (oldLanguage != lang) {
        ...
        return successFunc(loadedLanguage);
    ...
    var fallbackValueForKey = function(key){
      var data = fallbackLanguageData;
    ...
    valueForKey = function(key, data) {
      ...
      if((typeof value === 'undefined' || value === null) && originalKey !== 'undefined'){
        value = fallbackValueForKey(originalKey);
      }
      return value;
    };
